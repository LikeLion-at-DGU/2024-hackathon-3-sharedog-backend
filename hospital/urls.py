...
from .views import HospitalViewSet, DogViewSet, ReservationViewSet, HospitalReservationVieSet
...
hospital_reservation_router.register('reservation', HospitalReservationVieSet, basename='reservation')
